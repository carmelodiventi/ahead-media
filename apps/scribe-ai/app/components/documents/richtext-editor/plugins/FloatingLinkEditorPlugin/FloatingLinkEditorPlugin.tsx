 ...
 *
 */
import './FloatingLinkEditorPlugin.style.css'
...
function FloatingLinkEditor({
    ...
    const $updateLinkEditor = useCallback(() => {
        ...
        } else if (!activeElement || activeElement.className !== 'LinkEditorInput') {
            if (rootElement !== null) {
    ...
    return (
        <div ref={editorRef} className="LinkEditor">
            {!isLink ? null : isLinkEditMode ? (
                <Flex
                    ...
                    width={'100%'}
                    direction="row"
                    className="LinkEditorInputWrapper"
                >
                    <input
                        ref={inputRef}
                        className="LinkEditorInput"
                        value={editedLinkUrl}
                        onChange={(event) => {
                ...
                <div className="LinkView">
                    <Link href={sanitizeUrl(linkUrl)} target="_blank" rel="noopener noreferrer">
                        {linkUrl}
                    </Link>
                    <div>
                        <Button
