...
import './ParagraphPlaceholderPlugin.styles.css'
        ...
        const removeUpdateListener = editor.registerUpdateListener(({ editorState }) => {
            ...
            editorState.read(() => {
                ...
                if (paragraphRef?.current) {
                    ...
                    paragraphRef.current.classList.remove("ParagraphPlaceholder")
                ...
                if (paragraphDOMElement instanceof HTMLParagraphElement) {
                    ...
                    paragraphRef.current.classList.add("ParagraphPlaceholder")
                }
            })
        })
...
export default ParagraphPlaceholderPlugin
