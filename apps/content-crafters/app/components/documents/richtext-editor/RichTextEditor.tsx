...
function RichTextEditor({ document }: { document: DocumentTypes }) {
    ...
    const handleEditorChange = debounce((editorState: EditorState, editor: LexicalEditor) => {
        editor.read(() => {
        ...
        <LexicalComposer initialConfig={initialConfig}>
            <Grid columns={{ initial: '1', md: '2', lg: '6' }} gap={'5'}>
                ...
                <Flex
                    ...
                    height="100%"
                >
                    <Panels document={document} handleQuery={handleQuery} liveSearchResults={liveSearchResults} />
                </Flex>
            </Grid>
        </LexicalComposer>
    )
